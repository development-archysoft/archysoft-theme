...
<div class="archive_post archive_case">
    <div class="container">
        ...
        <div class="archive_post__container">
            ...
            $wpb_all_query = new WP_Query(array('post_type' => 'vacancies', 'paged' => $paged,  'post_status' => 'publish', 'posts_per_page' => 6, 'order' => 'DESC', 'orderby' => 'date', ));?>
            <?php if ($wpb_all_query->have_posts()) : ?>
                <?php while ($wpb_all_query->have_posts()) : $wpb_all_query->the_post(); ?>
                    <div class="archive_post__item archive_post__case" onclick="window.open('<?php the_permalink(); ?>', '_self');return true;">
                        <img  class="archive_item_img archive_vacs_img lozad" src="<?php echo the_post_thumbnail_url() ?>" data-srcset='<?php echo the_post_thumbnail_url() ?>' srcset="data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo the_post_thumbnail_url() ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>">
