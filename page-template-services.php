...
<div class="container">
    <div class="hero_wrapper" id="hero">
        <div class="hero_wraps">
            ...
            <?php if (have_rows('sertifications')) : ?>
                    <div class="sertificate_wrapper pc">
                        <?php if(!empty(get_field("developers_sertifications_title"))) : ?>
                        <p class="sertificate_title">
                            <?php the_field("developers_sertifications_title"); ?> 
                        </p>
                        <?php endif; ?>
        ...
        <?php if (have_rows('sertifications')) : ?>
                    <div class="sertificate_wrapper mob">
                        <p class="sertificate_title">
                            Developers sertifications
                        </p>
                        <div class="sertificate_container">
                            <?php while (have_rows('sertifications')) : the_row(); ?>
                                <div style="background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==) ;" data-background-image='<?php the_sub_field("sertificat"); ?>' class="sertificat_img__hero lozad"></div>
...
<?php if (have_rows('content')) : ?>
        <?php while (have_rows('content')) : the_row(); ?>
            ...
            <?php elseif (get_row_layout() == 'block_how') : ?>
                ...
                <?php elseif (get_row_layout() == 'achievement_block_chess') : ?>
            <?php get_template_part('include/achievement_block_chess'); ?>
            <?php elseif (get_row_layout() == 'mvp_banner') : ?>
                <?php get_template_part('include/service-mvp'); ?>
            <?php endif; ?>
        <?php endwhile; ?>
    <?php endif; ?>
</div>
