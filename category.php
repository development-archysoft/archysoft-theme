...
<div class="archive_post">
    <div class="container">
        ...
        <div class="archive_post__container">
            ...
            $wpb_all_query = new WP_Query(array('post_type' => 'post', 'paged' => $paged,  'post_status' => 'publish', 'posts_per_page' => 10, 'cat' => get_category(get_queried_object_id())->term_id, 'order' => 'DESC', 'orderby' => 'date',)); ?>
