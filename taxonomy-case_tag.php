...
<div class="archive_post archive_case">
    <div class="container">
        ...
        <div class="archive_post__container">
            ...
            $current_term = get_queried_object(); // Отримати поточний термін таксономії
            $tag_slug = $current_term->slug; // Отримати його слаг
            ...
            $wpb_all_query = new WP_Query(array(
                ...
                'tax_query' => array(
                    array(
                        'taxonomy' => 'case_tag', // Назва вашої таксономії
                        'field' => 'slug',
                        'terms' => $tag_slug, // Використовуємо слаг поточного терміна таксономії
                    ),
                ),
            ));?>
            <?php if ($wpb_all_query->have_posts()) : ?>
                <?php while ($wpb_all_query->have_posts()) : $wpb_all_query->the_post(); ?>
                    <div class="archive_post__item archive_post__case" onclick="window.open('<?php the_permalink(); ?>', '_self');return true;">
                        <img  class="archive_item_img lozad" src="<?php echo the_post_thumbnail_url() ?>" data-srcset='<?php echo get_the_post_thumbnail_url(get_the_ID(), array(1024, 1024)); ?>' srcset="data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php echo get_the_post_thumbnail_url(get_the_ID(), array(1024, 1024)); ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id(), '_wp_attachment_image_alt', true); ?>">
