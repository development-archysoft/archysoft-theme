        ...
        <div class="archive_post__container">
            <div class="post_left">
                ...
                if ($tag && isset($tag->slug)) {
                    $wpb_all_query = new WP_Query(array('post_type' => 'post', 'paged' => $paged, 'post_status' => 'publish', 'posts_per_page' => 10, 'order' => 'DESC', 'orderby' => 'date', 'tax_query' => array(array('taxonomy' => 'post_tag', 'field' => 'slug', 'terms' => $tag->slug))));
